...
// -----------------------------
// 👇 TU TAREA: Completa esta función (UPDATE)         // Debes permitir actualizar nombre, carnet y/o edad
...
{
    int nuevo_nombre, nuevo_carnet, nueva_edad;
    string buscar;
    ifstream archivo("estudiantes.txt");
    ...
    if (archivo.is_open() && temp.is_open())
    {
        while (archivo >> e.nombre >> e.carnet >> e.edad)
        {
            ...
            {
                Estudiante renovar;
                cout << "Por favor ingrese el nuevo nombre a renovar: " << endl;
                cin >> renovar.nombre;

                cout << "Por favor ingrese nuevo carnet a renovar: " << endl;
                cin >> renovar.carnet;

                cout << "Por favor ingrese nueva edad a renovar: " << endl;
                cin >> renovar.edad;

                temp << renovar.nombre << renovar.carnet << renovar.edad << endl;
        ...
        {
            cout << "Error al querer modificar a estudiante, no encontrado" << endl;
        }
    }
}
